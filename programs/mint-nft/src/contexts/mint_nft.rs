...
use crate::utils::get_nft_uri;

use super::LaunchpadInfo;
...
pub struct MintNFT<'info> {
    ...
    #[account(mut, seeds = [b"collection", collection_mint.key().as_ref()], bump = launchpad_info.bump)]
...
impl<'info> MintNFT<'info> {
    pub fn mint_nft(
        ...
        launchpad_info.mint_count = &launchpad_info.mint_count + 1;
        ...
        let metadata_account = CreateMetadataAccountV3Cpi::new(
            ...
            CreateMetadataAccountV3InstructionArgs {
                data: DataV2 {
                    name: launchpad_info.name.to_string(),
                    symbol: launchpad_info.symbol.to_string(),
                    uri: get_nft_uri(launchpad_info.uri.as_str(), launchpad_info.mint_count as i64),
                    seller_fee_basis_points: launchpad_info.fee_basis,
